...
public class ControllerTest extends TestCase {
     ...
     */
    public void setUp() {
        controller = new Controller(64, 512, 128); // Example sizes
    ...
    public void testSampleInserts() {
        ...
        controller.insert(1, "Overview of HCI Research at VT", "0610051600", 90, 
            (short)10, (short)10, 45, 
            new String[] { "HCI", "Computer_Science", "VT", "Virginia_Tech" }, 
        ...
        // Insert 2
        controller.insert(2, "Computational Biology and Bioinformatics in CS at Virginia Tech", "0610071600", 60, 
            (short)20, (short)10, 30, 
            new String[] { "Bioinformatics", "computation_biology", "Biology", "Computer_Science", "VT", "Virginia_Tech" }, 
        ...
        // Insert 10
        controller.insert(10, "Overview of HPC and CSE Research at VT", "0703301125", 35, 
            (short)0, (short)0, 25, 
            new String[] { "HPC", "CSE", "computer_science" }, 
            "Learn what kind of research is done on HPC and CSE at VT");
        assertOutput("Successfully inserted record with ID 10\n"
...
//        
//        // Insert 3
//        controller.insert(3, "Computing Systems Research at VT", "0701250830", 30, 
//            (short)30, (short)10, 17, 
//            new String[] { "high_performance_computing", "grids", "VT", "computer science" }, 
