...
public class MemManagerTest {
    ...
    private int initialMemorySize = 1024; // Set initial memory size for the pool
    ...
    public void testInsertDataIntoMemoryPool() {
        ...
        // Verify the data is inserted correctly by checking the handle position and size
    ...
    public void testRemoveDataAndMergeBlocks() {
        ...
        // Remove a block and check if it gets freed and adjacent blocks are merged
        ...
        assertTrue(firstFreeBlock.getSize() > 0); // This checks if memory is merged correctly
    }
    ...
    public void testRemoveAfterExpand() {
        ...
        // Verify that memory usage decreases and the remaining free space is correct
